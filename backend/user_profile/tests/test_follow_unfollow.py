...
class FollowUnfollowTests(APITestCase):
    ...
    def test_follow_user(self):
        ...
        self.assertEqual(response.data['message'], f'{self.user1.username} successfully followed {self.user2.username}.')
    ...
    def test_unfollow_user(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data['message'], f'{self.user1.username} successfully unfollowed {self.user2.username}.')
